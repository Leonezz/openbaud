...
Homebrew, or an install hook. The v0.1.3 bundle currently supports macOS Apple
...
ambiguous installation before installing v0.1.3:
...
Re-register the pinned marketplace to use v0.1.3:
