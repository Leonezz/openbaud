...
ffmpeg -y -loglevel error \
  ...
  -filter_complex \
  "[0:a]volume=0.10,lowpass=f=180[a0];[1:a]volume=0.055,lowpass=f=260[a1];[2:a]volume=0.025,lowpass=f=360[a2];[3:a]lowpass=f=900,highpass=f=90,volume=0.18[a3];[4:a]volume=0.10,afade=t=out:st=0.06:d=0.42,adelay=5000|5000[p1];[5:a]volume=0.09,afade=t=out:st=0.06:d=0.42,adelay=12000|12000[p2];[4:a]volume=0.10,afade=t=out:st=0.06:d=0.42,adelay=20000|20000[p3];[5:a]volume=0.09,afade=t=out:st=0.06:d=0.42,adelay=33000|33000[p4];[4:a]volume=0.12,afade=t=out:st=0.06:d=0.42,adelay=40000|40000[p5];[a0][a1][a2][a3][p1][p2][p3][p4][p5]amix=inputs=9:normalize=0,afade=t=in:st=0:d=1.5,afade=t=out:st=43:d=3,loudnorm=I=-20:LRA=7:TP=-2[a]" \
...
ffmpeg -y -loglevel error -ss 18 -t 10 -i "$FINAL" \
  -filter_complex \
